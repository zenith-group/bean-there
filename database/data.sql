...
FROM '/home/ourscat/hackreactor/blueOcean/bean-there/database/coffee_type_data.csv' -- REPLACE THIS
DELIMITER ',';


COPY reviews (user_id, rating, coffee_type, drink_name, review_body, date, store_id)
FROM '/home/ourscat/hackreactor/blueOcean/bean-there/database/reviews.csv' -- REPLACE THIS
